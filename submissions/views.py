        ...
        for test_case in test_cases:
            ...
            try:
                if language == 'python':
                    ...
                    with open('files/User.java', 'w') as code_file:
                        code_file.write(user_code)
                    subprocess.run(['javac', 'files/User.java'], check=True)
                    result = subprocess.run(
                        ['java', 'User'],
                        input=input_data,
                        text=True,
                    ...
                    with open('files/user_code.cpp', 'w') as code_file:
                        code_file.write(user_code)
                    subprocess.run(['g++', 'files/user_code.cpp', '-o', 'files/user_code.exe'], check=True)
                    result = subprocess.run(
                        ['./user_code.exe'],
                        input=input_data,
                        text=True,
                    ...
                    with open('files/user_code.js', 'w') as code_file:
                        code_file.write(user_code)
                    result = subprocess.run(
                        ['node', 'files/user_code.js'],
                        input=input_data,
                        text=True,
                        capture_output=True,
                        timeout=5
